            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
                    {testimonials.map((testimonial, index) => (
                        <div key={index} className="bg-card p-6 rounded-lg shadow-md zoom-in" style={{ animationDelay: `${(index + 1) * 100}ms` }}>
                ...
                <div className="flex justify-center">
                    <Link href="/testimonials" className="text-primary hover:underline font-semibold transition-colors">
