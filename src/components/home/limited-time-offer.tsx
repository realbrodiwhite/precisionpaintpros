...
export default function LimitedTimeOffer() {
    ...
    return (
<section className="bg-primary text-primary-foreground py-8 text-center border-t-8 border-b-4 border-red-500 outline outline-red-500 outline-8 outline-offset-0" style={{ borderTopWidth: '8px', borderTopStyle: 'solid', borderTopColor: '#ef4444', borderBottomWidth: '4px', borderBottomStyle: 'solid', borderBottomColor: '#ef4444' }}>
